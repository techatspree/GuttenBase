...
public class DatabaseMetaDataInspectorTool {
  ...
  private void updateColumnsWithPrimaryKeyInformation(final java.sql.DatabaseMetaData metaData, DatabaseMetaData databaseMetaData, final TableMetaData table)
      throws SQLException {
