...
public class DatabaseCustomSchemaScriptCreator {
    ...
    private String createColumn(final ColumnMetaData columnMetaData) throws Exception {
        final ColumnMapper columnMapper = _connectorRepository.getConnectorHint(_targetConnectorId, ColumnMapper.class).getValue();
        final CustomColumnTypeMapper columnTypeMapper = _connectorRepository.getConnectorHint(_sourceConnectorId, CustomColumnTypeMapper.class).getValue();
        final StringBuilder builder = new StringBuilder();

        builder.append(columnMapper.mapColumnName(columnMetaData, columnMetaData.getTableMetaData())).append(" ").append(columnTypeMapper.mapColumnType(columnMetaData, sourceType, targetType));
